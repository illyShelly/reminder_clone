...
struct PersistenceController {
    ...
    init(inMemory: Bool = false) { // when true - the simulator shows 'clean' data (doesn't upload stored data)
        ...
        container.loadPersistentStores(completionHandler: { (storeDescription, error) in // the primary fce - 'load data from the container'
...
//Removed PersistenceController for preview
